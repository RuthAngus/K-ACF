...
def runSim(amp = 0.01, N = 1, doplot = True, dur = 50, number_of_data_sets = 12, myperiod = [10.0], star_name = 1, spot_tau = 1, Amplitude = 1.0):
    tau = spot_tau
    diffrot = scipy.zeros(N) + 0.5
    for q in range(0, number_of_data_sets):
