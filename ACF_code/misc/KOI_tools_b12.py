import scipy, pyfits, atpy, glob, pylab, copy, asciitable, os

#PlanetCands = atpy.Table('/Volumes/Data/kepler/m_rot_paperdata/Bahtalha12_PlanetCandidates.txt', type='ascii',name='PlanetCands')
